# ===================================================================================
# fastapi_review/routers/test_main.py
#   2026-06-30
#   
...
def setup_db():
    ...
    # teatdown : 테스트가 끝난 뒤 정리(청소)하는 작업
    print('\n[teatdown] 테스트 테이블 삭제 완료!')
...
def test_user_has_items(client):
    """유저 조회 시 item배열에 아이템이 포함되어있는지 확인 (1:N 관계 검증)"""
    response = client.get('/users/1')
